...
[testReact](http://localhost)

</div>

<div>

[testNg](http://localhost)
...
```js 4:5 subtitle="mark page components to be lazy loaded using 'React.lazy()' function" file=./samples/react/lazyLoading.js
