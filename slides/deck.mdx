...
```ts 39:41 subtitle="define it as an object on the component class" file=./samples/ng/form.ts
...
```diff 19,27,35 subtitle="create the form using ngForm directive and bind the model using ngModel"
...
```diff 29 subtitle="create the fields needed in the template"

```

```diff 22:30 subtitle="create the fields needed in the template using Field component and name of the field"
