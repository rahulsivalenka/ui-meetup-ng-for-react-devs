...
```jsx 19,23,27 subtitle="wrap all content with BrowserRouter to provide routing" file=./samples/react/routing.js

```

```ts subtitle="have to import RouterModule in the needed module" file=./samples/ng/routing.ts
