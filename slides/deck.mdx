...
```diff 28:30 subtitle="useLayoutEffect hook with empty array is called once synchronously on init"
...
```jsx 16:19 subtitle="return function inside a useEffect callback is called on destroy" file=./samples/react/MyComp/MyComp1.js
